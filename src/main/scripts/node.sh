...
start() {
   ...
   if [ $pid -ne 0 ]; then
      ...
      JAVA_CMD="nohup $JAVA_HOME/bin/java $JAVA_OPTS -classpath $CLASSPATH -jar $APP_HOME/$APP_NAME $COMMAND_NAME >$APP_HOME/logs/$LOG_NAME 2>&1 &"
